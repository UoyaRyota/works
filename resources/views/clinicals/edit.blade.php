        ...
        <div class="col-10">
            ...
            <form action="{{ route('clinicals.update', $clinical->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label>名前</label>
                    <input type="text" class="form-control @if($errors->has('name')) validation_border @endif"
                        placeholder="名前" name="name" value="{{ $clinical->name }}">
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex">
                        <input type="number"
                            class="form-control @if($errors->has('age')) validation_border @endif input_age"
                            placeholder="29" name="age" value="{{ $clinical->age }}"> <span class="d-block p-3">歳</span>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="sex" id="radio2a" value="男" @if (old('sex',
                            $clinical->sex) == '男') checked @endif>
                        <label class="form-check-label" for="radio2a">男</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="sex" id="radio2b" value="女" @if (old('sex',
                ...
                <div class="form-group">
                    ...
                    <input type="tel"
                        ...
                        placeholder="090-1111-2222" name="tel_num" value="{{ $clinical->tel_num }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @if($errors->has('email')) validation_border @endif"
                        placeholder="test@gmail.com" name="email" value="{{ $clinical->email }}">
                    @if ($errors->has('email'))
                    <ul class="validation_message text-danger">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        placeholder="733-0003" name="postal_num" value="{{ $clinical->postal_num }}" size="10"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @if($errors->has('address')) validation_border @endif"
                        placeholder="広島県呉市" name="address" value="{{ $clinical->address }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @if($errors->has('needs')) validation_border @endif"
                        placeholder="content" rows="5" name="needs">{{ $clinical->needs }}</textarea>
                    @if ($errors->has('needs'))
                    <ul class="validation_message text-danger">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        placeholder="CVA" name="medical_history_f" value="{{ $clinical->medical_history_f }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        placeholder="MSA" name="medical_history_s" value="{{ $clinical->medical_history_s }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        placeholder="その他" name="medical_history_t" value="{{ $clinical->medical_history_t }}">
                ...
                <div class="form-group">
                    <label>ROM</label>
                    <input type="text" class="form-control @if($errors->has('rom')) validation_border @endif"
                        placeholder="肩関節外転" name="rom" value="{{ $clinical->rom }}">
                    @if ($errors->has('rom'))
                    <ul class="validation_message text-danger">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @if($errors->has('work')) validation_border @endif"
                        placeholder="プログラマ" name="work" value="{{ $clinical->work }}">
                    @if ($errors->has('work'))
                    <ul class="validation_message text-danger">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @if($errors->has('others')) validation_border @endif"
                        placeholder="content" rows="5" name="others">{{ $clinical->others }}</textarea>
