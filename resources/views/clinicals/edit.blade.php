    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
              ...
              <form action="{{ route('clinicals.update', $clinical->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label>年齢</label>
                    <input type="number" class="form-control @if($errors->has('age')) validation_border @endif" placeholder="29" name="age" value="{{ $clinical->age }}">歳
                    @if ($errors->has('age')) 
                        <ul class="validation_message" style="color: red;">
                ...
                <div class="form-group">
                    <label>電話番号</label>
                    <input type="tel" class="form-control @if($errors->has('tel_num')) validation_border @endif" placeholder="090-1111-2222" name="tel_num" value="{{ $clinical->tel_num }}">
                ...
                <div class="form-group">
                    <label>郵便番号</label>
                    <input type="text" class="form-control @if($errors->has('postal_num')) validation_border @endif" placeholder="733-0003" name="postal_num" value="{{ $clinical->postal_num }}" size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');">
